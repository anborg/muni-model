...
public class TestSubsystemService {
    ...
    public void demo_mapping_at_integSubsystem_GetPerson_360() {
        ...
        var amandaXref = Model.Xref.newBuilder().setSysId("AMANDA").setPersonId("12345").addRecentCases(amdCase).build();
        var hansenXref = Model.Xref.newBuilder().setSysId("HANSEN").setPersonId("67890").addRecentCases(hansCase).build();
