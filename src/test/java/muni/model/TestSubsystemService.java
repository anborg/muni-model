...
public class TestSubsystemService {
    ...
    public void demo_mapping_at_integSubsystem_GetPerson_360() {
        ...
        var amandaXref = Model.Xref.newBuilder().setXrefSysId("AMANDA").setXrefPersonId("12345").addRecentCases(amdCase).build();
        var hansenXref = Model.Xref.newBuilder().setXrefSysId("HANSEN").setXrefPersonId("67890").addRecentCases(hansCase).build();
